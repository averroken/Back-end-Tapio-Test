define({ "api": [
  {
    ...
    "version": "0.0.0",
    "filename": "C:/Users/DarthSwedo/Documents/GitHub/Back-end-Tapio-Test/Routes/rootRoutes.js",
    "groupTitle": "Default"
  },
  {
    "type": "get",
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "refreshtoken",
            "description": "<p>The <code>refreshtoken</code> that the user received in the email</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "post",
    "url": "upload?landmarkId",
    "title": "Upload Image",
    "name": "Upload_Image",
    "group": "Upload_an_Image",
    "description": "<p>Route to handle the upload of an image.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "landmarkId",
            "description": "<p>The <code>landmarkId</code> of the landmark that the image is assigned to.</p>"
          }
        ]
      }
    },
    "version": "0.0.0",
    "filename": "C:/Users/DarthSwedo/Documents/GitHub/Back-end-Tapio-Test/Routes/uploadRoutes.js",
    "groupTitle": "Upload_an_Image"
  }
] });
